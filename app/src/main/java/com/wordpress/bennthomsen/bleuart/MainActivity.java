                ...
                if (!mBtAdapter.isEnabled()) {
                    ...
                    if (btnConnectDisconnect.getText().equals("Connect")){
                      ...
                      //  Intent newIntent = new Intent(MainActivity.this, DeviceListActivity.class);
                        ...
                        mService.connect("C9:7B:CF:C5:A7:42");
...
/*
                if(flag==2){
                    message="2o";
                    listAdapter.add("["+currentDateTimeString+"] OTWARTE DRZWI NR 2");
                    flag=3;}
                else {
                    message="2c";
                    listAdapter.add("["+currentDateTimeString+"] ZAMKNIĘTE DRZWI NR 2");
                    flag=2;
                }
*/
        ...
        btnSend2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(flag_3=="3c"){
                    message="3o";
                    listAdapter.add("["+currentDateTimeString+"] OTWARTE DRZWI NR 3");
                    flag_3="3o";}
                else {
                    message="3c";
                    listAdapter.add("["+currentDateTimeString+"] ZAMKNIĘTE DRZWI NR 3");
                    flag_3="3c";
                }
